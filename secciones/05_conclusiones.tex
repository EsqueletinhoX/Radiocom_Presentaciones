...
\begin{frame}{Conclusiones}
  \begin{columns}[T]
    ...
    \begin{block}{Enlace B}
      ...
      \begin{itemize}
        ...
        \item SNR de \EBsnr\ $\Rightarrow$ 16QAM; $\approx$80 Mbps $>$ 50 Mbps requeridos.
      \end{itemize}
    \end{block}
  \end{columns}
  \vspace{4pt}
  \begin{alertblock}{Generales}
    ...
    El diseño es un compromiso entre capacidad, robustez frente al ruido y costo; la modulación
