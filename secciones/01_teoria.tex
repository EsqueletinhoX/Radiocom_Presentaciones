...
\begin{frame}{Objetivo de la actividad}
  \small
  \textbf{Radioenlace:} interconexión entre terminales de telecomunicación mediante ondas
  electromagnéticas, típicamente entre 800 MHz y 50 GHz.
  \vspace{4pt}
  \begin{block}{Parte 1}
...
\begin{frame}{Componentes principales de un enlace PtP}
  ...
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item \textbf{Antena:} convierte corrientes de RF en ondas dirigidas y viceversa (parábolas, bocinas).
      ...
      \item \textbf{Cableado de datos y de RF:} UTP/FTP o fibra; coaxiales o guías de onda si la radio está separada.
      \item \textbf{Conectores y bridas:} RJ45, N, SMA; uniones precisas para evitar ROE.
    \end{itemize}
    \column{0.5\textwidth}
    \begin{itemize}
...
\begin{frame}{Parámetros principales (2/2)}
  ...
  \begin{tabularx}{\textwidth}{@{}p{3.6cm}L@{}}
    ...
    Interferencias & Señales externas co-canal o de canal adyacente; se mitigan con la antena (\emph{deep reflectors}) o filtros. \\
